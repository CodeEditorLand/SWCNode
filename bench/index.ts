...
import {
	...
	transformSync as transformSyncNapi,
} from "@swc-node/core";
import Benchmark, { Suite } from "benchmark";
import { green } from "colorette";
import {
	transform as transformEsbuild,
	transformSync as transformSyncEsbuild,
} from "esbuild";
...
const asyncSuite = new Suite(
	"Transform rxjs/AjaxObservable.ts async benchmark",
);

const parallelSuite = new Suite(
	"Transform rxjs/AjaxObservable.ts parallel benchmark",
);
